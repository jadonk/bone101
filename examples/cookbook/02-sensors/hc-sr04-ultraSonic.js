...
// This version measures from the fall of the Trigger pulse to the end of the Echo pulse
...
b.digitalWrite(trigger, 1);     // Unit tirggers on a falling edge.
                                // Set trigger high to so we call pull it low later
